...
<title>${message("admin.main.title")} - Powered By Nbcyl</title>
<meta name="author" content="Nbcyl Team" />
<meta name="copyright" content="www.nbcyl.com" />
		...
		<tr>
			<td id="menu" class="menu">
				...
				<dl id="system">
					...
					[/@shiro.hasPermission]
						<dd>
							<a href="../data_dict/list.jhtml" target="iframe">${message("admin.main.datadict")}</a>
						</dd>
				...
				<dl id="seller">
					...
					<dd>
						<a href="../elderlySuppliesSeller/edit.jhtml" target="iframe">${message("admin.main.elderlySuppliesSeller")}</a>
					</dd>
				</dl>
			</td>
			<td>
