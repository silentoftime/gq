	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="caption" class="text" maxlength="222" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<label>
						<input type="checkbox" name="focusFigure" value="true" checked="checked" />${message("Article.focusFigure")}
						<input type="hidden" name="focusFigure" value="false" />
					</label>
				</td>
			</tr>
			<tr>
