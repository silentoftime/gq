...
<link href="${base}/resources/shop/css/16sucai_com.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/resources/shop/js/indexSlide/slide1.js"></script>
	...
	<div class="container index">
		...
		<div class="span18">
			<div class="hotBrand clearfix">
				<div class="title">
					<a href="${base}/member/list/1.jhtml">所有会员</a>
					<strong>协会人员</strong>ASSOCIATION
				</div>
				<ul>
					[@member_list type = "image" count = 8]
						[#list members as member]
							<li>
								<a href="${base}${member.path}" title="${member.name}">
									<img src="${base}${member.picture}" alt="${member.name}" />
			...
			<div class="hotProductCategory">
						...
						<table>
							[#list productCategories as rootProductCategory]
								<tr[#if !rootProductCategory_has_next] class="last"[/#if]>
									<th>
										<a href="${base}${rootProductCategory.path}">六壬起课</a>
									</th>
									<td>
										[#list rootProductCategory.children as productCategory]
											<a href="${base}${productCategory.path}">紫微排盘</a>
										[/#list]
									</td>
								</tr>
							[/#list]
				...
				<!-- 优选视频 开始 -->
				<a name="media">
				<div class="mainCon layer2">
					<div class="lTrade GM1 GM2">
						<div class="titleGeneral title1">
							<a href="${base}/media/245.jhtml" target="_blank"><h2>案例展示<span>ANLIZHANSHI</span></h2></a>
							<div class="rollBox">
							<div  class="img1">
								<img onmousedown="ISL_GoUp()" onmouseup="ISL_StopUp()" onmouseout="ISL_StopUp()"   src="${base}/resources/shop/img/index/index/l_left.png" width="14" height="24" /></div>
						     <div class="Cont" id="ISL_Cont">
						      <div class="ScrCont">
						       <div id="List1" class="shipin_list_index">
						        <!--视频列表 begin -->
						        	[@product_category_root_list count=8 ]
										[#list productCategories as articleItem]
									        <div class="pic">
									            <a href="${articleItem.path}" target="_blank" class="img_list"><img  src="${articleItem.path}" alt="${articleItem.path}"/></a>
									            <font><a href="${articleItem.path}" target="_blank"><img src="${base}/resources/shop/img/index/index/img_f.png"></a></font>
									            <label title="${articleItem.path}">${abbreviate(articleItem.path,24,"")}</label>
									         </div>
								         [/#list]
									[/@product_category_root_list]
						        <!-- 视频列表 end -->
							 ...
							 <div class="img2">
								<img onmousedown="ISL_GoDown()" onmouseup="ISL_StopDown()" onmouseout="ISL_StopDown()"  src="${base}/resources/shop/img/index/index/l_right.jpg" width="14" height="24" /></div>
						    </div>
						</div>
					</div>
				</div>
		...
		<div class="span6 last">
			<div class="newReview">
				<div class="title">免费测试专栏</div>
				<ul>
					<li>      
						<div>
							<form action="${base}/nameLuck/index.jhtml" method="GET">
								<ul>
									<li>
										<h3>姓名测试：</h3>
									</li>
									...
									<li>
										<input type="submit" value="测试" style="float:right"/>
									</li>
								</ul>
							</form>
						</div>
